    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Update un Utilisateur</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="card-title">Update un Utilisateur</h5>
                <hr>
                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="inputProductTitle" value="{{ $user->name }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Nom Organisateur</label>
                                        <input type="text" name="telephone" class="form-control" id="inputProductTitle" value="{{ $user->telephone }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Email de l'Organisateur</label>
                                        <input name="email" type="email" class="form-control" id="inputProductTitle" value="{{ $user->email }}">
                                    </div>

                                    <!-- <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Mot de passe de l'Organisateur</label>
                                        <input name="password" type="password" class="form-control" id="inputProductTitle" value="{{ $user->name }}">
                                    </div>
